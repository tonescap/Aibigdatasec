...
if __name__ == "__main__":
    ...
    argparser.add_argument('--dir_path',           type=str, required=True,         help='malicious powershell directory path')
    argparser.add_argument('--decode_dir_path',    type=str, required=True,         help='decoded powershell directory path (will be decoded on this folder)')
